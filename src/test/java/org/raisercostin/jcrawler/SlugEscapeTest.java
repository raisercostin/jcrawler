...
class SlugEscapeTest {
  @Test
  void test() {
    String slug = SlugEscape.contentPathInitial(
  ...
  void testCollisions() {
    ...
    assertThat(SlugEscape.contentPathInitial(url1)).isEqualTo(
    ...
    assertThat(SlugEscape.contentPathInitial(url2)).isEqualTo(
